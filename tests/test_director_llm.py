...
def test_director_llm_json_becomes_storyboard():
    ...
    raw = '{"style":"cinematic","scenes":[{"scene_id":"001","asset_id":"a","duration_frames":90,"entrance":{"type":"none"},"motion":{"type":"static"},"transition":{"type":"fade","duration_frames":6,"direction":"from-right","intensity":0.6,"easing":"easeInOut"},"emotion":"dramatic"}]}'
