...
def test_render_data_contains_animation(tmp_path, monkeypatch):
    ...
    animation = AnimationEffect(asset_id="a", effect=AnimationEffectType.card_flip_reveal, component="CardFlipReveal", implementation="custom", duration_frames=18, props={}, fallback=AnimationEffectType.none)
