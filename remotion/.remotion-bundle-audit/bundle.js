...
const TransitionRegistry = {
  ...
  push_left: (c, k) => transitions_element(k, c, pushCut({ incomingStartScale: 1 })),
  push_right: (c, k) => transitions_element(k, c, pushCut({ incomingStartScale: 1 })),
  push_up: (c, k) => transitions_element(k, c, pushCut({ incomingStartScale: 1 })),
  push_down: (c, k) => transitions_element(k, c, pushCut({ incomingStartScale: 1 })),
  push: (c, k) => transitions_element(k, c, push({ incomingStartScale: 1 })),
