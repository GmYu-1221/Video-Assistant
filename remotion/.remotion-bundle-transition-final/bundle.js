...
;// ./src/transitions/presentations/types.ts
...
const transitions_element = (key, c, p) => /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries.Transition, { timing: timing(c), presentation: p }, key);
