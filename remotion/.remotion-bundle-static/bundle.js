...
const ImageFrame = ({ src, motion = "static" }) => {
  const frame = (0,esm/* useCurrentFrame */.UC)();
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("img", { src, style: { width: "100%", height: "100%", objectFit: "cover", transform } });
};
...
const Slideshow = (props) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: "black" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries, { children: props.timeline.flatMap((item, index) => {
      ...
      const sequence = /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries.Sequence, { durationInFrames: item.duration_frames + transitionFrames, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ImageFrame, { src: `${base}/${(asset == null ? void 0 : asset.relative_path) ?? ""}`, motion: (asset == null ? void 0 : asset.motion) ?? "static" }) }, `sequence-${item.asset_id}`);
