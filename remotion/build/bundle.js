...
// EXTERNAL MODULE: ./node_modules/.pnpm/remotion@4.0.507_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/remotion/dist/esm/index.mjs
var esm = __webpack_require__(8305);
// EXTERNAL MODULE: ./node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(6070);
// EXTERNAL MODULE: ./node_modules/.pnpm/react@18.3.1/node_modules/react/index.js
var react = __webpack_require__(758);
// EXTERNAL MODULE: ./node_modules/.pnpm/remotion@4.0.507_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/remotion/dist/esm/no-react.mjs
var no_react = __webpack_require__(7724);
;// ./node_modules/.pnpm/@remotion+transitions@4.0.507_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@remotion/transitions/dist/esm/index.mjs
/* unused harmony import specifier */ var useMemo3;
/* unused harmony import specifier */ var interpolate;
/* unused harmony import specifier */ var Easing;
/* unused harmony import specifier */ var AbsoluteFill3;
/* unused harmony import specifier */ var jsxs2;
/* unused harmony import specifier */ var jsx3;
/* unused harmony import specifier */ var measureSpring;
/* unused harmony import specifier */ var spring;
/* unused harmony import specifier */ var React5;
...
var SlidePresentation = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, {
    style,
    children
  });
};
...
var HtmlInCanvasPresentation = ({
  ...
  if (!esm/* HtmlInCanvas */.jC.isSupported()) {
    throw new Error(esm/* HTML_IN_CANVAS_UNSUPPORTED_MESSAGE */.JF);
  }
  ...
  const memoizedEffects = esm/* Internals */.Xp.useMemoizedEffects({
    effects: effects ?? [],
    overrideId: null
  });
  ...
  const chainState = esm/* Internals */.Xp.useEffectChainState();
  const { delayRender, continueRender } = (0,esm/* useDelayRender */.dB)();
  const draw = (0,react.useCallback)(async (prevImage, nextImage, progress) => {
    ...
    await esm/* Internals */.Xp.runEffectChain({
...
var linearTiming = (options) => {
  return {
    ...
    getProgress: ({ frame }) => {
      return (0,esm/* interpolate */.GW)(frame, [0, options.durationInFrames], [0, 1], {
...
var validateDurationInFrames = no_react/* NoReactInternals */.JC.validateDurationInFrames;

// src/TransitionSeries.tsx

var { SequenceWithoutSchema } = esm/* Internals */.Xp;
...
var TransitionSeriesTransition = esm/* Interactive */.HG.withSchema({
...
var SeriesOverlay = esm/* Interactive */.HG.withSchema({
...
var transitionSeriesSequenceSchema = {
  durationInFrames: esm/* Internals */.Xp.durationInFramesField,
  name: esm/* Internals */.Xp.sequenceSchema.name,
  hidden: esm/* Internals */.Xp.sequenceSchema.hidden,
  showInTimeline: esm/* Internals */.Xp.sequenceSchema.showInTimeline,
  freeze: esm/* Internals */.Xp.freezeField,
  trimBefore: esm/* Internals */.Xp.sequenceSchema.trimBefore,
  layout: esm/* Internals */.Xp.sequenceSchema.layout
};
...
var SeriesSequence = esm/* Interactive */.HG.withSchema({
...
var transitionSeriesSchema = {
  ...
  hidden: esm/* Internals */.Xp.sequenceSchema.hidden,
  showInTimeline: esm/* Internals */.Xp.sequenceSchema.showInTimeline,
  from: esm/* Internals */.Xp.fromField,
  freeze: esm/* Internals */.Xp.freezeField,
  layout: esm/* Internals */.Xp.sequenceSchema.layout
};
      ...
      return react.cloneElement(castedChildAgain, {
        _remotionInternalRender: (resolvedProps) => {
          ...
          const propsForSequence = {
            ...passedProps,
            _remotionInternalSingleChildComponent: esm/* Internals */.Xp.getSingleChildComponent(sequenceChildren)
          };
...
var TransitionSeriesInner = (props) => {
  ...
  if (no_react/* NoReactInternals */.JC.ENABLE_V5_BREAKING_CHANGES && layout !== "absolute-fill") {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Sequence */.gd, {
    name: displayName,
    layout,
...
var TransitionSeries = esm/* Interactive */.HG.withSchema({
...
const ImageFrame = ({ src, imageWidth, imageHeight, motion = "static", entrance, backgroundColor = "#000000" }) => {
  ...
  const entranceType = (entrance == null ? void 0 : entrance.type) ?? "fade";
  ...
  let y = entranceY;
  if (motion !== "static") {
    const progress = (0,esm/* interpolate */.GW)(frame, [0, durationInFrames], [0, 1], {
      extrapolateRight: "clamp",
      easing: esm/* Easing */.GS.inOut(esm/* Easing */.GS.quad)
    });
...
const AudioTrack = ({ src }) => /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Audio */.fP, { src: src.startsWith("http") ? src : (0,esm/* staticFile */.dQ)(src), volume: 0.85 });

;// ./node_modules/.pnpm/@remotion+transitions@4.0.507_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@remotion/transitions/dist/esm/fade.mjs
...
;// ./src/transitions/fade.ts



;// ./node_modules/.pnpm/@remotion+transitions@4.0.507_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@remotion/transitions/dist/esm/flip.mjs
...
var Flip = ({
  ...
  const style = (0,react.useMemo)(() => {
    ...
    const rotation = presentationDirection === "entering" ? (0,esm/* interpolate */.GW)(presentationProgress, [0, 1], [startRotationEntering, 0]) : (0,esm/* interpolate */.GW)(presentationProgress, [0, 1], [0, endRotationEntering]);
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, {
    style: outer,
    children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, {
      style,
      children
    })
  });
...
;// ./src/transitions/flip.ts



;// ./node_modules/.pnpm/@remotion+transitions@4.0.507_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@remotion/transitions/dist/esm/slide.mjs
// src/presentations/slide.tsx
...
;// ./node_modules/.pnpm/@remotion+transitions@4.0.507_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@remotion/transitions/dist/esm/wipe.mjs
...
;// ./node_modules/.pnpm/@remotion+transitions@4.0.507_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@remotion/transitions/dist/esm/zoom-blur.mjs
// src/html-in-canvas-presentation.tsx



var zoom_blur_HtmlInCanvasPresentation = ({
  children,
  onElementImage,
  onUnmount,
  presentationProgress,
...
var zoom_blur_makeHtmlInCanvasPresentation = (shader) => {
  const CompWithShader = (props) => {
    const { passedProps, ...otherProps } = props;
    const { effects, ...restPassedProps } = props.passedProps;
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(zoom_blur_HtmlInCanvasPresentation, {
      shader,
      passedProps: restPassedProps,
      effects,
      ...otherProps
...
// src/presentations/upload-element-image.ts
var zoom_blur_uploadElementImage = (gl, elementImage) => {
  gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, elementImage);
};

// src/presentations/zoom-blur.tsx
var zoom_blur_VERTEX_SHADER = `#version 300 es
in vec2 a_pos;
out vec2 v_uv;
void main() {
	v_uv = vec2(a_pos.x * 0.5 + 0.5, 0.5 - a_pos.y * 0.5);
...
var zoom_blur_FRAGMENT_SHADER = `#version 300 es
precision highp float;
...
var zoom_blur_compileShader = (gl, source, type) => {
  const shader = gl.createShader(type);
  if (!shader) {
    throw new Error("Failed to create shader");
  }
...
var zoom_blur_createProgram = (gl) => {
  const program = gl.createProgram();
  if (!program) {
    throw new Error("Failed to create WebGL program");
  }
  const vs = zoom_blur_compileShader(gl, zoom_blur_VERTEX_SHADER, gl.VERTEX_SHADER);
  const fs = zoom_blur_compileShader(gl, zoom_blur_FRAGMENT_SHADER, gl.FRAGMENT_SHADER);
  gl.attachShader(program, vs);
  gl.attachShader(program, fs);
  gl.linkProgram(program);
  if (!gl.getProgramParameter(program, gl.LINK_STATUS)) {
...
var zoom_blur_createTexture = (gl) => {
  const tex = gl.createTexture();
  if (!tex) {
    throw new Error("Failed to create texture");
  }
...
var zoomBlurShader = (canvas) => {
  ...
  const program = zoom_blur_createProgram(gl);
  const prevTex = zoom_blur_createTexture(gl);
  const nextTex = zoom_blur_createTexture(gl);
  const vao = gl.createVertexArray();
  gl.bindVertexArray(vao);
  const buffer = gl.createBuffer();
  gl.bindBuffer(gl.ARRAY_BUFFER, buffer);
  ...
  const draw = ({
    ...
    gl.bindTexture(gl.TEXTURE_2D, prevTex);
    if (prevImage) {
      zoom_blur_uploadElementImage(gl, prevImage);
    }
    gl.uniform1i(uPrev, 0);
    gl.activeTexture(gl.TEXTURE1);
    gl.bindTexture(gl.TEXTURE_2D, nextTex);
    if (nextImage) {
      zoom_blur_uploadElementImage(gl, nextImage);
    }
    gl.uniform1i(uNext, 1);
    gl.uniform1f(uTime, effectiveTime);
...
var zoomBlur = zoom_blur_makeHtmlInCanvasPresentation(zoomBlurShader);


;// ./src/transitions/zoom_blur.ts



;// ./src/transitions/presentations/types.tsx



const presentation = (component) => ({ component: (props) => {
  const color = props.passedProps.backgroundColor;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: color ? `rgb(${color.r}, ${color.g}, ${color.b})` : "#111827" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { children: component(props) }) });
}, props: {} });

;// ./src/transitions/presentations/crossfade.tsx




const crossfade = () => presentation(({ children, presentationProgress, presentationDirection }) => /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { opacity: presentationDirection === "entering" ? presentationProgress : 1 - presentationProgress }, children }));

;// ./src/transitions/presentations/black_flash.tsx




const blackFlash = () => presentation(({ children, presentationProgress, presentationDirection }) => /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { children: [
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { opacity: presentationDirection === "entering" ? presentationProgress : 1 }, children }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: "#000", opacity: Math.sin(presentationProgress * Math.PI) } })
] }));

;// ./src/transitions/presentations/white_flash.tsx




const whiteFlash = () => presentation(({ children, presentationProgress, presentationDirection }) => /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { children: [
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { opacity: presentationDirection === "entering" ? presentationProgress : 1 }, children }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: "#fff", opacity: Math.sin(presentationProgress * Math.PI) } })
] }));

;// ./src/transitions/presentations/push.tsx




const push = () => presentation(({ children, presentationProgress, presentationDirection }) => /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { transform: `translateX(${presentationDirection === "entering" ? 100 - presentationProgress * 100 : -presentationProgress * 100}%)` }, children }));

;// ./src/transitions/presentations/whip.tsx
...
const digitalWipe = () => presentation(({ children, presentationProgress, presentationDirection }) => /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { clipPath: `inset(0 ${presentationDirection === "entering" ? 100 - presentationProgress * 100 : presentationProgress * 100}% 0 0)` }, children }));

;// ./src/transitions/presentations/iris.tsx




const iris = () => presentation(({ children, presentationProgress, presentationDirection }) => /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { clipPath: `circle(${(presentationDirection === "entering" ? presentationProgress : 1 - presentationProgress) * 75}% at 50% 50%)` }, children }));

;// ./src/transitions/presentations/clock_wipe.tsx




const clockWipe = () => presentation(({ children, presentationProgress, presentationDirection }) => {
  const p = presentationDirection === "entering" ? presentationProgress : 1 - presentationProgress;
  const a = p * 360;
  const rad = (a - 90) * Math.PI / 180;
  const x = 50 + 50 * Math.cos(rad);
  const y = 50 + 50 * Math.sin(rad);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { clipPath: `polygon(50% 50%, 50% 0%, ${a < 90 ? `${x}% ${y}%` : "100% 0%"}, ${a < 180 ? `${x}% ${y}%` : "100% 100%"}, ${a < 270 ? `${x}% ${y}%` : "0% 100%"}, ${a < 360 ? `${x}% ${y}%` : "0% 0%"})` }, children });
});

;// ./src/transitions/presentations/blinds.tsx




const blinds = () => presentation(({ children, presentationProgress, presentationDirection }) => {
  const p = presentationDirection === "entering" ? presentationProgress : 1 - presentationProgress;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { children: Array.from({ length: 8 }, (_, index) => {
    const local = Math.max(0, Math.min(1, p * 1.35 - index * 0.05));
    return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: 0, right: 0, top: `${index * 12.5}%`, height: "12.5%", overflow: "hidden" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { transform: `translateY(${-index * 12.5}%)`, clipPath: `inset(0 0 ${(1 - local) * 100}% 0)` }, children }) }, index);
  }) });
});

;// ./src/transitions/presentations/pixel_reveal.tsx




const pixelReveal = () => presentation(({ children, presentationProgress, presentationDirection }) => {
  const p = presentationDirection === "entering" ? presentationProgress : 1 - presentationProgress;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { children: [
    children,
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { pointerEvents: "none", opacity: 1 - p, backgroundImage: "linear-gradient(90deg,#000 50%,transparent 50%),linear-gradient(#000 50%,transparent 50%)", backgroundSize: "32px 32px", mixBlendMode: "multiply" } })
  ] });
});

;// ./src/transitions/presentations/glitch.tsx




const glitch = () => presentation(({ children, presentationProgress, presentationDirection }) => {
  const decay = 1 - presentationProgress;
  const offset = Math.sin(presentationProgress * 47) * decay * 9;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { style: { opacity: presentationDirection === "entering" ? Math.min(1, presentationProgress * 1.7) : 1 }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { transform: `translateX(${offset}px)`, mixBlendMode: "screen", opacity: decay * 0.45, filter: "sepia(1) saturate(6) hue-rotate(315deg)" }, children }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { transform: `translateX(${-offset}px)`, mixBlendMode: "screen", opacity: decay * 0.35, filter: "sepia(1) saturate(7) hue-rotate(165deg)" }, children }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { clipPath: `inset(${35 + Math.sin(presentationProgress * 31) * 20}% 0 ${35 - Math.sin(presentationProgress * 31) * 20}% 0)`, transform: `translateX(${offset * 1.4}px)` }, children }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { children })
  ] });
});

;// ./src/transitions/presentations/light_leak.tsx




const lightLeak = () => presentation(({ children, presentationProgress, presentationDirection }) => /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { children: [
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { opacity: presentationDirection === "entering" ? presentationProgress : 1 }, children }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { background: "radial-gradient(circle at 20% 50%, rgba(255,170,60,.9), transparent 65%)", mixBlendMode: "screen", opacity: Math.sin(presentationProgress * Math.PI) * 0.8 } })
] }));

;// ./src/transitions/metadata.ts

const custom = (complexity, duration, usesMask = false, usesTransform = false) => ({ implementation: "custom", complexity, defaultDurationFrames: duration, supportedDirections: ["from-left", "from-right"], usesMask, usesTransform });
const TransitionMetadataRegistry = {
  fade: { implementation: "native", complexity: 0.1, defaultDurationFrames: 6, supportedDirections: [], usesMask: false, usesTransform: false },
  slide: { implementation: "native", complexity: 0.3, defaultDurationFrames: 6, supportedDirections: ["from-left", "from-right"], usesMask: false, usesTransform: true },
  slide_left: { implementation: "native", complexity: 0.3, defaultDurationFrames: 6, supportedDirections: ["from-left"], usesMask: false, usesTransform: true },
  slide_right: { implementation: "native", complexity: 0.3, defaultDurationFrames: 6, supportedDirections: ["from-right"], usesMask: false, usesTransform: true },
  wipe: { implementation: "native", complexity: 0.3, defaultDurationFrames: 6, supportedDirections: ["from-left", "from-right"], usesMask: true, usesTransform: false },
  wipe_left: { implementation: "native", complexity: 0.3, defaultDurationFrames: 6, supportedDirections: ["from-left"], usesMask: true, usesTransform: false },
  wipe_right: { implementation: "native", complexity: 0.3, defaultDurationFrames: 6, supportedDirections: ["from-right"], usesMask: true, usesTransform: false },
  flip: { implementation: "native", complexity: 0.5, defaultDurationFrames: 6, supportedDirections: ["from-left", "from-right"], usesMask: false, usesTransform: true },
  zoom_blur: { implementation: "native", complexity: 0.6, defaultDurationFrames: 6, supportedDirections: [], usesMask: false, usesTransform: true },
  crossfade: custom(0.2, 8),
...
const timing = (c) => linearTiming({ durationInFrames: c.duration_frames });
const transitions_element = (key, c, p) => {
  const presentation = { ...p, component: (props) => {
    const color = c.background_color;
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: color ? `rgb(${color.r}, ${color.g}, ${color.b})` : "#111827" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(p.component, { ...props }) });
  }, props: { ...p.props, backgroundColor: c.background_color } };
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries.Transition, { timing: timing(c), presentation }, key);
};
const direction = (c) => c.direction === "from-left" ? "from-left" : "from-right";
const TransitionRegistry = {
  fade: (c, k) => transitions_element(k, c, fade()),
  crossfade: (c, k) => transitions_element(k, c, crossfade()),
  black_flash: (c, k) => transitions_element(k, c, blackFlash()),
  ...
  blinds: (c, k) => transitions_element(k, c, blinds()),
  pixel_reveal: (c, k) => transitions_element(k, c, pixelReveal()),
  glitch: (c, k) => transitions_element(k, c, glitch()),
  light_leak: (c, k) => transitions_element(k, c, lightLeak()),
  slide: (c, k) => transitions_element(k, c, slide_slide({ direction: direction(c) })),
  slide_left: (c, k) => transitions_element(k, c, slide_slide({ direction: "from-left" })),
  slide_right: (c, k) => transitions_element(k, c, slide_slide({ direction: "from-right" })),
  wipe: (c, k) => transitions_element(k, c, wipe({ direction: direction(c) })),
  wipe_left: (c, k) => transitions_element(k, c, wipe({ direction: "from-left" })),
...
const Root = () => /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Composition */.BO, { id: "Slideshow", component: Slideshow, width: 1920, height: 1080, fps: 30, durationInFrames: 150, defaultProps: {}, calculateMetadata: ({ props }) => ({ width: props.width, height: props.height, fps: props.fps, durationInFrames: Math.max(...(props.timeline ?? []).map((x) => x.end_frame), 1) }) });

;// ./src/index.ts



(0,esm/* registerRoot */.eU)(Root);
...
var __require = /* @__PURE__ */ (/* unused pure expression or super */ null && (((x) =>  true ? __webpack_require__(4720) : 0)(function(x) {
  if (true)
    return __webpack_require__(4720).apply(this, arguments);
...
/* harmony import */ var _chunk_fgedsvhb_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3100);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(758);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9576);
/* harmony import */ var remotion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8305);
/* harmony import */ var remotion_no_react__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7724);
...
remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.CSSUtils.injectCSS(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.CSSUtils.makeDefaultPreviewCSS(null, _chunk_fgedsvhb_js__WEBPACK_IMPORTED_MODULE_0__/* .BACKGROUND_HEX */ .lR));
...
var DelayedSpinner = () => {
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_3__/* .AbsoluteFill */ .H1, {
    style: {
      justifyContent: "center",
      alignItems: "center",
      fontSize: 13,
...
var GetVideoComposition = ({ state }) => {
  const { compositions, currentCompositionMetadata, canvasContent } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.CompositionManager);
  const { setCanvasContent } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.CompositionSetters);
  const portalContainer = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const { delayRender, continueRender } = (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .useDelayRender */ .dB)();
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    ...
    current.appendChild(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.portalNode());
    continueRender(handle);
    return () => {
      current.removeChild(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.portalNode());
    };
...
var waitForRootHandle = (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .delayRender */ .IH)("Loading root component - See https://remotion.dev/docs/troubleshooting/loading-root-component if you experience a timeout", {
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "composition") {
    const markup = /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.CompositionManagerProvider, {
      ...
      initialCompositions: [],
      children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.RemotionRootContexts, {
        frameState: null,
        ...
        children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.RenderAssetManagerProvider, {
          collectAssets: null,
          children: [
  ...
  if (bundleMode.type === "evaluation") {
    const markup = /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.CompositionManagerProvider, {
      ...
      children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.RemotionRootContexts, {
        ...
        audioLatencyHint: window.remotion_audioLatencyHint ?? "playback",
        previewSampleRate: window.remotion_previewSampleRate,
        children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.RenderAssetManagerProvider, {
          collectAssets: null,
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(224), __webpack_require__.e(840), __webpack_require__.e(348)]).then(__webpack_require__.bind(__webpack_require__, 6840)).then(({ StudioInternals }) => {
...
remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.waitForRoot((Root) => {
  renderContent(Root);
  (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .continueRender */ ._8)(waitForRootHandle);
});
var setBundleModeAndUpdate = (state) => {
  setBundleMode(state);
  const delay = (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .delayRender */ .IH)("Waiting for root component to load - See https://remotion.dev/docs/troubleshooting/loading-root-component if you experience a timeout");
  remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.waitForRoot((Root) => {
    renderContent(Root);
    requestAnimationFrame(() => {
      (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .continueRender */ ._8)(delay);
    });
  });
};
if (typeof window !== "undefined") {
  const getUnevaluatedComps = () => {
    if (!remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.getRoot()) {
    ...
    if (!remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.compositionsRef.current) {
      throw new Error("Unexpectedly did not have a CompositionManager");
    }
    const compositions = remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.compositionsRef.current.getCompositions();
    const canSerializeDefaultProps = getCanSerializeDefaultProps(compositions);
    if (!canSerializeDefaultProps) {
      remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.Log.warn({ logLevel: window.remotion_logLevel ?? "info", tag: null }, "defaultProps are too big to serialize - trying to find the problematic composition...");
      remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.Log.warn({ logLevel: window.remotion_logLevel ?? "info", tag: null }, "Serialization:", compositions);
      ...
      remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.Log.warn({ logLevel: window.remotion_logLevel ?? "info", tag: null }, "Could not single out a problematic composition -  The composition list as a whole is too big to serialize.");
  ...
  window.getStaticCompositions = () => {
    ...
    const inputProps = typeof window === "undefined" || (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .getRemotionEnvironment */ .P1)().isPlayer ? {} : (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .getInputProps */ .ti)() ?? {};
    return Promise.all(compositions.map(async (c) => {
      const handle = (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .delayRender */ .IH)(`Running calculateMetadata() for composition ${c.id}. If you didn't want to evaluate this composition, use "selectComposition()" instead of "getCompositions()"`);
      const originalProps = {
        ...c.defaultProps ?? {},
        ...inputProps ?? {}
      };
      const comp = remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.resolveVideoConfig({
      ...
      (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .continueRender */ ._8)(handle);
  ...
  window.remotion_calculateComposition = async (compId) => {
    ...
    const handle = (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .delayRender */ .IH)(`Running the calculateMetadata() function for composition ${compId}`);
    const inputProps = typeof window === "undefined" || (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .getRemotionEnvironment */ .P1)().isPlayer ? {} : (0,remotion__WEBPACK_IMPORTED_MODULE_3__/* .getInputProps */ .ti)() ?? {};
    const originalProps = {
      ...selectedComp.defaultProps ?? {},
      ...inputProps ?? {}
    };
    const prom = await Promise.resolve(remotion__WEBPACK_IMPORTED_MODULE_3__/* .Internals */ .Xp.resolveVideoConfig({
...
/* harmony export */   HG: () => (/* binding */ Interactive),
/* harmony export */   IH: () => (/* binding */ delayRender),
/* harmony export */   JF: () => (/* binding */ HTML_IN_CANVAS_UNSUPPORTED_MESSAGE),
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(758);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8143);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "content-creator-remotion:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcontent_creator_remotion"] = self["webpackChunkcontent_creator_remotion"] || [];
