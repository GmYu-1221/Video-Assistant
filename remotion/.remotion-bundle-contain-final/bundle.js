...
var PushCutPresentation = ({
  ...
  const outgoingProgress = (0,esm/* interpolate */.GW)(presentationProgress, [0, cutProgress], [0, 1], {
    ...clamp,
    easing: esm/* Easing */.GS.in(esm/* Easing */.GS.quad)
  });
  const incomingProgress = (0,esm/* interpolate */.GW)(presentationProgress, [cutProgress, 1], [0, 1], {
    ...clamp,
    easing: esm/* Easing */.GS.out(esm/* Easing */.GS.quad)
  });
  const scale = isEntering ? (0,esm/* interpolate */.GW)(incomingProgress, [0, 1], [incomingStartScale, incomingEndScale]) : (0,esm/* interpolate */.GW)(outgoingProgress, [0, 1], [1, outgoingScale]);
  ...
  const flashOpacity = isEntering ? (0,esm/* interpolate */.GW)(presentationProgress, [cutProgress, cutProgress + flashTail], [peakFlashOpacity, 0], clamp) : (0,esm/* interpolate */.GW)(presentationProgress, [cutProgress - oneFrame, cutProgress], [0, peakFlashOpacity], clamp);
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, {
    style: outerStyle,
    children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, {
        style: innerStyle,
        children
      }),
      flashOpacity > 0 ? /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, {
        style: {
...
const timing = (config) => linearTiming({ durationInFrames: config.duration_frames });
const transitions_element = (key, config, presentation) => /* @__PURE__ */ (0,jsx_runtime.jsx)(TransitionSeries.Transition, { timing: timing(config), presentation }, key);
const direction = (config) => config.direction === "from-left" ? "from-left" : "from-right";
const TransitionRegistry = {
  fade: (c, k) => transitions_element(k, c, fade()),
  crossfade: (c, k) => transitions_element(k, c, fade()),
  dissolve: (c, k) => transitions_element(k, c, fade()),
  ...
  slide_up: (c, k) => transitions_element(k, c, slide_slide({ direction: "from-left" })),
  slide_down: (c, k) => transitions_element(k, c, slide_slide({ direction: "from-right" })),
  ...
  // Keep incoming scenes at contain scale; no transition-level upscaling.
  push_left: (c, k) => transitions_element(k, c, pushCut({ incomingStartScale: 1, incomingEndScale: 1, outgoingScale: 1 })),
  push_right: (c, k) => transitions_element(k, c, pushCut({ incomingStartScale: 1, incomingEndScale: 1, outgoingScale: 1 })),
  push_up: (c, k) => transitions_element(k, c, pushCut({ incomingStartScale: 1, incomingEndScale: 1, outgoingScale: 1 })),
  push_down: (c, k) => transitions_element(k, c, pushCut({ incomingStartScale: 1, incomingEndScale: 1, outgoingScale: 1 })),
  push: (c, k) => transitions_element(k, c, push({ incomingStartScale: 1, incomingEndScale: 1, outgoingScale: 1 })),
  ...
  diagonal_reverse: (c, k) => transitions_element(k, c, wipe({ direction: "from-right" })),
  iris: (c, k) => transitions_element(k, c, wipe({ direction: "from-left" })),
  radial: (c, k) => transitions_element(k, c, wipe({ direction: "from-right" })),
  flip: (c, k) => transitions_element(k, c, flip({ direction: direction(c) })),
  flip_x: (c, k) => transitions_element(k, c, flip({ direction: "from-left" })),
  flip_y: (c, k) => transitions_element(k, c, flip({ direction: "from-right" })),
  rotate: (c, k) => transitions_element(k, c, flip({ direction: "from-right" })),
  cube_left: (c, k) => transitions_element(k, c, flip({ direction: "from-left" })),
