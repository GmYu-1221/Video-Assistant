...
const element = <P extends Record<string, unknown>>(key: string, c: TransitionConfig, p: TransitionPresentation<P>): ReactElement => <TransitionSeries.Transition key={key} timing={timing(c)} presentation={p}/>;
