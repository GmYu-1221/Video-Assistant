...
export const TransitionRegistry: Record<string, TransitionBuilder> = {
  ...
  push_left: (c, k) => element(k, c, pushCut({incomingStartScale: 1, incomingEndScale: 1, outgoingScale: 1})), push_right: (c, k) => element(k, c, pushCut({incomingStartScale: 1, incomingEndScale: 1, outgoingScale: 1})), push_up: (c, k) => element(k, c, pushCut({incomingStartScale: 1, incomingEndScale: 1, outgoingScale: 1})), push_down: (c, k) => element(k, c, pushCut({incomingStartScale: 1, incomingEndScale: 1, outgoingScale: 1})),
  push: (c, k) => element(k, c, push({incomingStartScale: 1, incomingEndScale: 1, outgoingScale: 1})), whip: (c, k) => element(k, c, whip({direction: direction(c)})), zoom_cut: (c, k) => element(k, c, zoomCut()), spin: (c, k) => element(k, c, spin({direction: direction(c)})), glitch: (c, k) => element(k, c, glitch({direction: direction(c)})),
