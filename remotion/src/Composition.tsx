  ...
  return <AbsoluteFill style={{backgroundColor: 'black'}}>
    <TransitionSeries>
      {props.timeline.flatMap((item, index) => {
        ...
        const safeTransitionEffect = transitionEvent && ['card_flip_transition', 'glass_shatter_transition', 'shake_transition', 'gaussian_blur_transition', 'directional_blur_transition', 'pixel_blur_transition', 'bokeh_blur_transition', 'water_ripple_transition'].includes(transitionEvent.type) ? {
